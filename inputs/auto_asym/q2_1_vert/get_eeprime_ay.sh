...
sort -t ' ' -k1 vert_3he_q2_1_eeprime_asym_v_runnum_for_runs_20596-20789.txt > temp_eeprime.txt
sort -t ' ' -k1 q2_1_ch-lt.txt > temp_charge.txt
sort -t ' ' -k1 q2_1_prescales.txt > temp_prescales.txt
join -t ' ' temp_eeprime.txt temp_charge.txt > temp_q2_1_near_final.txt
join -t ' ' temp_q2_1_near_final.txt temp_prescales.txt > temp_q2_1_eeprime_final.txt


file0="temp_q2_1_eeprime_final.txt"
awk '$1>20000 && $1<30000 && $28>0 && $30>0 {print $1,$8,$9,$31*1.5577E-10,$33*1.5577E-10,$16*$37/$28,$19*$37/$30}' $file0 > temp_q2_1_eeprime_evt_ch_lt.txt
#							Run #	EvtUp	EvtDwn	ChUp	ChDwn	LtUp	LtDwn
#							$1		$2		$3		$4		$5		$6		$7	


file1="./temp_q2_1_eeprime_evt_ch_lt.txt"
awk '$1>20000 && $1<30000 && $4*$6>0 && $5*$7>0 && ($2+$3)>0 {print $1,$2/($4*$6),$3/($5*$7),1/sqrt($2+$3)}' $file1 > temp_q2_1_eeprime_yields.txt
#							Run #	YieldUp		YieldDwn	1/sqrt(N)	
#							$1		$2			$3			$4		


file2="./temp_q2_1_eeprime_yields.txt"
awk '$1>20000 && $1<30000 && ($2+$3)>0 {print $1,($2-$3)/($2+$3),$4}' $file2 > final_q2_1_eeprime_asym.txt
#							Run #	Ay0		dAy0
#							$1		$2		$3

file3="../yawei_info.txt"
awk '$1>20595 && $1<20790 {print $1,$10,$11}' $file3 > temp_q2_1_yawei_eeprime.txt
#							Run #	Ay0		dAy0
#							$1		$2		$3

file7="./final_q2_1_eeprime_asym.txt"
...
#xmgrace\
gracebat -hdevice PNG	-printfile plot_q2_1_eeprime_asym.png \
		 -settype xydy	-block temp_q2_1_yawei_eeprime.txt	-graph 0 -bxy 1:2:3 \
		 -settype xydy	-block final_q2_1_eeprime_asym.txt	-graph 0 -bxy 1:2:3 \
		 -settype xy	-block temp_ave_eeprime_asym.txt	-graph 0 -bxy 1:2 \
		 -p q2_1_eeprime_asym.par	-noask

display plot_q2_1_eeprime_asym.png
