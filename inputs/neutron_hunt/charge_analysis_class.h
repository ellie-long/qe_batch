...
#ifndef charge_analysis_class_h
#define charge_analysis_class_h
...
public :
 ...
 //THaEvent        *Event_Branch;
   ...
   charge_analysis_class(TTree *tree=0);
   virtual ~charge_analysis_class();
...
charge_analysis_class::~charge_analysis_class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t charge_analysis_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t charge_analysis_class::LoadTree(Long64_t entry)
{
...
void charge_analysis_class::Init(TTree *tree)
{
...
Bool_t charge_analysis_class::Notify()
{
...
void charge_analysis_class::Show(Long64_t entry)
{
...
Int_t charge_analysis_class::Cut(Long64_t entry)
{
...
#endif // #ifdef charge_analysis_class_cxx
