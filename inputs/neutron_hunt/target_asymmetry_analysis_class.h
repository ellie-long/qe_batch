...
// Thu Oct 20 14:38:36 2011 by ROOT version 5.26/00
// from TChain T/
//////////////////////////////////////////////////////////

#ifndef target_asymmetry_analysis_class_h
#define target_asymmetry_analysis_class_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>

class target_asymmetry_analysis_class {
public :
   ...
   Double_t        R_tr_beta[10];   //[Ndata.R.tr.beta]
   Int_t           Ndata_R_tr_ph;
   Double_t        R_tr_ph[10];   //[Ndata.R.tr.ph]
   Int_t           Ndata_R_tr_th;
   Double_t        R_tr_th[10];   //[Ndata.R.tr.th]
   Int_t           Ndata_R_tr_x;
   Double_t        R_tr_x[10];   //[Ndata.R.tr.x]
   Int_t           Ndata_R_tr_y;
   Double_t        R_tr_y[10];   //[Ndata.R.tr.y]
 ...
 //THaEvent        *Event_Branch;
   ...
   target_asymmetry_analysis_class(TTree *tree=0);
   virtual ~target_asymmetry_analysis_class();
...
#ifdef target_asymmetry_analysis_class_cxx
target_asymmetry_analysis_class::target_asymmetry_analysis_class(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("./e05102_R_20487.root/T");
      chain->Add("./e05102_R_20487_1.root/T");
      chain->Add("./e05102_R_20487_2.root/T");
      tree = chain;
#endif // SINGLE_TREE
...
target_asymmetry_analysis_class::~target_asymmetry_analysis_class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t target_asymmetry_analysis_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t target_asymmetry_analysis_class::LoadTree(Long64_t entry)
{
...
void target_asymmetry_analysis_class::Init(TTree *tree)
{
...
Bool_t target_asymmetry_analysis_class::Notify()
{
...
void target_asymmetry_analysis_class::Show(Long64_t entry)
{
...
Int_t target_asymmetry_analysis_class::Cut(Long64_t entry)
{
...
#endif // #ifdef target_asymmetry_analysis_class_cxx
