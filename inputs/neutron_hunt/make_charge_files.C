...
//	chainHe->MakeClass("MyClass");
	cout << "Running charge_analysis_class..." << endl;
	chainHe->MakeClass("charge_analysis_class");
//	chainHe->MakeClass("target_asymmetry_analysis_class");
	cout << "Loading charge_analysis_class.*..." << endl;
	gROOT->ProcessLine(".L charge_analysis_class.C");
	gROOT->ProcessLine(".L charge_analysis_class.h");
	gROOT->ProcessLine(".L charge_analysis_class.cxx");
//	cout << "Defining MyClass ..." << endl;
	cout << "Defining charge_analsis_class ..." << endl;
//	MyClass m;
//	charge_analysis_class m;
	gROOT->ProcessLine("charge_analysis_class m");
