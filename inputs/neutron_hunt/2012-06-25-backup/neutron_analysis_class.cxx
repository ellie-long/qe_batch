...
void neutron_analysis_class::AsymLoop()
{
...
//	otherSpecs = "3He data, with NO veto cuts, but WITH inGoodBar cuts such that only the background is counted";
	...
	otherSpecs += "\nOther: ((Top 1/3) of the Bottom 1/3)";
...
//      int whichbar=11;
	...
	{
		if (!test && ((jentry%10000)==0)) {cout << "Processing Event " << jentry << "..." << endl;}
		if (test && (jentry%100)==0) {cout << "Processing Event " << jentry << "..." << endl;}
