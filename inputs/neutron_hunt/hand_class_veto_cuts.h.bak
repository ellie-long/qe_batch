...
// Define First Veto
	if (vetoplane=="veto") 
	{
		for (int i=0; i<maxBar; i++)
		{
			pastVetoL = (NA_veto_lt_c[i]<vetoTDCcutmin || NA_veto_lt_c[i]>vetoTDCcutmax) && pastVetoL;
			pastVetoR = (NA_veto_rt_c[i]<vetoTDCcutmin || NA_veto_rt_c[i]>vetoTDCcutmax) && pastVetoR;
			if (!pastVetoL) {i = maxBar;}
			if (!pastVetoR) {i = maxBar;}
		}
	}
	...
	{ 
		for (int i=0; i<maxBar; i++)
		{
			pastVetoL = ((NA_nd_p1_lt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_lt_c[i]<vetoTDCcutmin || NA_veto_lt_c[i]>vetoTDCcutmax) && pastVetoL);
			pastVetoR = ((NA_nd_p1_rt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_rt_c[i]<vetoTDCcutmin || NA_veto_rt_c[i]>vetoTDCcutmax) && pastVetoR);
			if (!pastVetoL) {i = maxBar;}
			if (!pastVetoR) {i = maxBar;}
		}
	}
	...
	{ 
		for (int i=0; i<maxBar; i++)
		{
			pastVetoL = ((NA_nd_p2_lt_c[i]<vetoTDCcutmin || NA_nd_p2_lt_c[i]>vetoTDCcutmax) && (NA_nd_p1_lt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_lt_c[i]<vetoTDCcutmin || NA_veto_lt_c[i]>vetoTDCcutmax) && pastVetoL);
			pastVetoR = ((NA_nd_p2_rt_c[i]<vetoTDCcutmin || NA_nd_p2_rt_c[i]>vetoTDCcutmax) && (NA_nd_p1_rt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_rt_c[i]<vetoTDCcutmin || NA_veto_rt_c[i]>vetoTDCcutmax) && pastVetoR);
			if (!pastVetoL) {i = maxBar;}
			if (!pastVetoR) {i = maxBar;}
		}
	}
	...
	{ 
		for (int i=0; i<maxBar; i++)
		{
			pastVetoL = ((NA_nd_p3_lt_c[i]<vetoTDCcutmin || NA_nd_p3_lt_c[i]>vetoTDCcutmax) && (NA_nd_p2_lt_c[i]<vetoTDCcutmin || NA_nd_p2_lt_c[i]>vetoTDCcutmax) && (NA_nd_p1_lt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_lt_c[i]<vetoTDCcutmin || NA_veto_lt_c[i]>vetoTDCcutmax) && pastVetoL);
			pastVetoR = ((NA_nd_p3_rt_c[i]<vetoTDCcutmin || NA_nd_p3_rt_c[i]>vetoTDCcutmax) && (NA_nd_p2_rt_c[i]<vetoTDCcutmin || NA_nd_p2_rt_c[i]>vetoTDCcutmax) && (NA_nd_p1_rt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_rt_c[i]<vetoTDCcutmin || NA_veto_rt_c[i]>vetoTDCcutmax) && pastVetoR);
			if (!pastVetoL) {i = maxBar;}
			if (!pastVetoR) {i = maxBar;}
		}
	}
	...
	{ 
		for (int i=0; i<maxBar; i++)
		{
			pastVetoL = ((NA_nd_p4_lt_c[i]<vetoTDCcutmin || NA_nd_p4_lt_c[i]>vetoTDCcutmax) && (NA_nd_p3_lt_c[i]<vetoTDCcutmin || NA_nd_p3_lt_c[i]>vetoTDCcutmax) && (NA_nd_p2_lt_c[i]<vetoTDCcutmin || NA_nd_p2_lt_c[i]>vetoTDCcutmax) && (NA_nd_p1_lt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_lt_c[i]<vetoTDCcutmin || NA_veto_lt_c[i]>vetoTDCcutmax) && pastVetoL);
			pastVetoR = ((NA_nd_p4_rt_c[i]<vetoTDCcutmin || NA_nd_p4_rt_c[i]>vetoTDCcutmax) && (NA_nd_p3_rt_c[i]<vetoTDCcutmin || NA_nd_p3_rt_c[i]>vetoTDCcutmax) && (NA_nd_p2_rt_c[i]<vetoTDCcutmin || NA_nd_p2_rt_c[i]>vetoTDCcutmax) && (NA_nd_p1_rt_c[i]<vetoTDCcutmin || NA_nd_p1_lt_c[i]>vetoTDCcutmax) && (NA_veto_rt_c[i]<vetoTDCcutmin || NA_veto_rt_c[i]>vetoTDCcutmax) && pastVetoR);
			if (!pastVetoL) {i = maxBar;}
			if (!pastVetoR) {i = maxBar;}
		}
	}
