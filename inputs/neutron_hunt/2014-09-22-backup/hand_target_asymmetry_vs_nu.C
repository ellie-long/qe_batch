...
//		if ((nplane==4) && (thisbar==7))  { nplane = 4; thisbar = 99;}
		...
		allGoodBarCutsStr += ") && (";
		allGoodBarCutsStr += thetaCutStr;
		allGoodBarCutsStr += ") && ((";
		allGoodBarCutsStr += vetoTDCslSt;
		allGoodBarCutsStr += ") && (";
		allGoodBarCutsStr += vetoTDCsrSt;
		allGoodBarCutsStr += ")))";
		if (((endplane-1)!=nplane) && ((maxbars-1)!=thisbar)) { allGoodBarCutsStr += " || ";}
	...
	cout << "allGoodBarCutsStr: " << allGoodBarCutsStr << endl;
	TCut allGoodCuts = cuts && allGoodBarCutsStr;
