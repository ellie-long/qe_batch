...
void replay_nohists_L(Int_t runnumber=0,Int_t all=0,Int_t fstEvt=0,Bool_t QuietRun = kFALSE)
{
...
// This needs information about the Point of interaction (hence a THaVertexModule)
 ...
 gHaPhysics->Add( TgC_l );
  ...
  // add scalers
// Modified by Ellie. Uncommect next two lines and delete those below
// if they stop working for some reason.
...
// Delete three lines above and uncomment the two above if this doesn't work
 ...
 ////////////////////////////////////////
  ...
  ReplayCore(
	    ...
	    "replay_nohists_L.odef",	//out define
	    "replay_nohists_L.cdef", 	//empty cut define
	    kTRUE,                 	//replay scalar?
