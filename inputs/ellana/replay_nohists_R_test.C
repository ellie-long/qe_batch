...
void replay_nohists_R_test(Int_t runnumber=0,Int_t all=0,Int_t fstEvt=0,Bool_t QuietRun = kFALSE)

{
  ...
  ReplayCore(
	    ...
	    "replay_nohists_R_test.odef",	//out define
	    "replay_nohists_R.cdef", 	//empty cut define
	    kTRUE,                 	//replay scalar?
