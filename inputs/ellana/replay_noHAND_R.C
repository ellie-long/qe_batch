...
void replay_noHAND_R(Int_t runnumber=0,Int_t all=0,Int_t fstEvt=0,Bool_t QuietRun = kFALSE)
...
// The two lines above are what I was talking about in previous comment 
  ...
  ReplayCore(
	    ...
	    "replay_noHAND_R.odef",	//out define
	    "replay_noHAND_R.cdef", 	//empty cut define
	    kTRUE,                 	//replay scalar?
