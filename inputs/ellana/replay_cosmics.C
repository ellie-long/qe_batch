...
void replay_cosmics(Int_t runnumber=0,Int_t all=0,Int_t fstEvt=0,Bool_t QuietRun = kFALSE)
...
// The two lines above are what I was talking about in previous comment 
  ...
  ReplayCore(
	    ...
	    "replay_cosmics.odef",	//out define
	    "replay_cosmics.cdef", 	//empty cut define
	    kTRUE,                 	//replay scalar?
