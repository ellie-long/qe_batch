...
#ifndef ROOT_THaScintPlane
#define ROOT_THaScintPlane
...
public:
	...
	THaScintPlane( const char* name, const char* description, 
...
protected:
	...
	THaScintPlane& operator=( const THaScintPlane& ) {return *this; }

public:

	ClassDef(THaScintPlane,4) // Describes scintillator plane with F1TDC as a subdetector
};
