...
//   HRSL->AddDetector( new THaCherenkov("a1", "A1 Cherenkov counter" ));
  ...
  cout<<"replay: adding LHRS track modules ..."<<endl;
  pB->MountOptics(new THaOpticsAnalytical("optics","BigBite Optics Child Class",pB,"rb"));
...
//   DL1->AddDetector(new THaADCHe3Spin("t3","copy of DL.t3[0], for .odef file",DL1));
  ...
  gHaPhysics->Add(new THaPrimaryKine("PriKineBB","kinematics of scattering of electron to BB","BB","urb",.939565));
  gHaPhysics->Add(new THaPrimaryKine("PriKineBBHe3","kinematics of scattering of electron to BB","BB","urb",3.016*0.931494));
//  gHaPhysics->Add(new THaPrimaryKine("PriKineL","kinematics of scattering of electron to BB","L","urb",.939565));

  gHaPhysics->Add(new THaPrimaryKine("PriKineL","kinematics of scattering of electron to BB","L","urb",.939565));
  gHaPhysics->Add(new THaPrimaryKine("PriKineLHe3","kinematics of scattering of electron to BB","L","urb",3.016*0.931494));
